...
public class SelectAllQuestion extends MultipleChoiceQuestion {
	...
	public int checkAnswer(String givenAnswer) {
		if (findMissingCorrectAnswers(givenAnswer) != 0 && findIncorrectGivenAnswers(givenAnswer) == 0) {
			...
			return (this.choices.length - findMissingCorrectAnswers(givenAnswer)
					- findIncorrectGivenAnswers(givenAnswer));
		}
	}
	 ...
	 * 
	 * This method is marked static as it does not depend upon any instance
	 * variables
	 */
